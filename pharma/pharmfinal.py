#this script is for getting the pharmacies on sulekha
...
for item in state[:9]:
	...
	for item1 in sec_lists:
		...
		if city_list[0] == "Tamil Nadu":  #############to be chnged
			flagcity_list  = 1
						...
						if flagli ==0:
							for a in li:
								...
								for link in a.find_all("a", {"class":"YPTRACK GAQ_C_BUSL"}):
									...
									if href1 =="/chennai/manigandan-medical-shop-jawahar-nagar-chennai_contact-address":    #############to be chnged
										flag = 1
										print "gotthelink@@@@@@@@@@@@"
