		...
		for item1 in div :
			...
			for a in li:
				...
				for link in a.find_all("a", {"class":"YPTRACK GAQ_C_BUSL"}):
					...
					sql = "INSERT INTO `test`(`Phone`, `Address`, `Email`, `Website`, `Contact Person`, `Working hrs`, `Categories`,`About`, `Clinic name`, `Link`, `Link sec`, `City`) VALUES (" +"'" +lis2["Phone/Mobile"]+"'"+",'"+lis2["Address"]+"'"+",'"+lis2["Email"]+"'"+",'"+lis2["Website"]+"'"+",'"+lis2["Contact Person"]+"'"+",'"+lis2["Working Hours"]+"'"+",'"+lis2["Categories"]+"'"+",'"+lis2["description"]+"'"+",'"+lis2["pull-left"]+"'"+",'"+lis2["Link"]+"'"+",'"+lis2["Link sec"]+"'"+",'"+city+"'"+ ")"
